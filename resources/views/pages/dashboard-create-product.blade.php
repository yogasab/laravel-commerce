                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" autofocus autocomplete="none"
                          value="Sepatu Keren" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="number" name="price" id="price" class="form-control" autofocus autocomplete="none"
                          value="200" />
                      </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="thumbnails" class="mt-2">Thumbnails</label>
