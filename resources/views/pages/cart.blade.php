        ...
        <div class="col-12 table-responsive">
          <table class="table table-borderless table-cart">
            ...
            <tbody>
              ...
              <tr>
                <td style="width: 20%">
                  <h3>Cart kamu kosong, <a style="text-decoration: none" href="{{ route('home') }}">belanja</a> dulu yuk
                  </h3>
                </td>
              </tr>
              @endforelse
        ...
        <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="address_two" name="address_two" value="Jalan Matraman Raya" />
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="zip_code" name="zip_code" value="13540" />
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="phone_number" name="phone_number" value="+62 123123123" />
            </div>
          </div>
        </div>
        <div class="row">
